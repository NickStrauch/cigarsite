...
class CigarsControllerTest < ActionController::TestCase
  ...
  test "should create cigar" do
    assert_difference('Cigar.count') do
      post :create, cigar: { brand_name: @cigar.brand_name, description: @cigar.description, mfgr: @cigar.mfgr, style: @cigar.style }
    end
  ...
  test "should update cigar" do
    patch :update, id: @cigar, cigar: { brand_name: @cigar.brand_name, description: @cigar.description, mfgr: @cigar.mfgr, style: @cigar.style }
    assert_redirected_to cigar_path(assigns(:cigar))
  end
